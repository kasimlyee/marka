...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  students: {
    ...
    update: (id, studentData) =>
      ipcRenderer.invoke("students-update", id, studentData),
  ...
  subjects: {
    ...
    update: (id, subjectData) =>
      ipcRenderer.invoke("subjects-update", id, subjectData),
  ...
  reports: {
    generatePDF: (reportData) =>
      ipcRenderer.invoke("reports-generate-pdf", reportData),
    generateBulk: (reportCriteria) =>
      ipcRenderer.invoke("reports-generate-bulk", reportCriteria),
  },
  ...
  files: {
    ...
    exportStudents: (format) =>
      ipcRenderer.invoke("files-export-students", format),
  ...
  security: {
    hashPassword: (password) =>
      ipcRenderer.invoke("security-hash-password", password),
    verifyPassword: (password, hash) =>
      ipcRenderer.invoke("security-verify-password", password, hash),
    encryptData: (data) => ipcRenderer.invoke("security-encrypt-data", data),
    decryptData: (encryptedData) =>
      ipcRenderer.invoke("security-decrypt-data", encryptedData),
  },
